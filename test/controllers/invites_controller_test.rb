...
class InvitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invite" do
    assert_difference('Invite.count') do
      post invites_url, params: { invite: { from_uid: @invite.from_uid, to_address: @invite.to_address } }
    end
  ...
  test "should update invite" do
    patch invite_url(@invite), params: { invite: { from_uid: @invite.from_uid, to_address: @invite.to_address } }
